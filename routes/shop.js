...
let { register, verifyContact, retryContactVerification, addProducts, viewOneProduct, viewProducts, readQrData, addToCart, viewCart, removeFromCart } = require("../controllers/shop_controller");
